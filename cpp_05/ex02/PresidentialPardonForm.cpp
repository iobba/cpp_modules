...
PresidentialPardonForm::PresidentialPardonForm(std::string tar_get) : AForm("PresidentialPardonForm", 25, 5), target(tar_get)
{
    std::cout << "A PresidentialPardonForm with " << target << "(target) has been created" << std::endl;
}
