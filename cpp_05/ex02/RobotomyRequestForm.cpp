...
RobotomyRequestForm::RobotomyRequestForm(std::string tar_get) : AForm("RobotomyRequestForm", 72, 45), target(tar_get)
{
    std::cout << "A RobotomyRequestForm with " << target << "(target) has been created" << std::endl;
}
